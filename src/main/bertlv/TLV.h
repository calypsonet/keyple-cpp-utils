 ...
 * @since 2.0
 */
class KEYPLEUTIL_API TLV : public std::enable_shared_from_this<TLV> {
public:
    /**
     ...
     * @since 2.0
     */
    bool parse(std::shared_ptr<Tag> tag, const int offset);
     ...
     *
     */
    friend KEYPLEUTIL_API std::ostream& operator<<(std::ostream& os, const TLV& tlv);
